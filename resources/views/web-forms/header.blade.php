<div class="row" style="border-bottom:1px solid #fff">
    ...
    <div class="col-xs-6 col-sm-6">
		<span class="search_input_box">
			...
			<img src="{{URL::asset('images/close-active.png')}}" class="seacrh_icon" id="remove_patient_button" style="width: 20px;height: 30px;padding-right: 4px;padding-top: 9px;margin-top: -4px;cursor: pointer; display:none;">
		</span>

    </div>
    <div class="col-xs-6 col-sm-6">
        <div class="dropdown select_form_dropdown">
			<p class="" type="" data-toggle="dropdown" style="display:none">Type of webforms
