<div class="col-xs-6 info_col">
    <div class="info_col">
        ...
        <span class="info_row arial_bold">
            ...
            <span id="to_be_called"></span>
        </span>
        <span class="section_separator"></span>
        <!-- <span class="info_row arial_bold">
            <span>Left Message/Waiting on return call</span>
        </span>
        <span class="info_row">
            <span>1st call</span>
            <span>2</span>
        ...
        <span class="info_row">
            <span>3rd call/Unreturned Call</span>
            <span>3</span>
        </span>
        <span class="section_separator"></span> -->
        <span class="info_row arial_bold title">
            <span>Scheduled</span>
            <span id="scheduled_total"></span>
        </span>
        <div id="scheduled">
