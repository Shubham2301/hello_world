...
<div class="content-section content-section-scheduling active" id="practice_section">
    {!! Form::open(array('url' => '/appointments', 'method' => 'GET', 'id' => 'form_select_provider')) !!} @if(array_key_exists('referraltype_id', $data)) {!! Form::hidden('referraltype_id', $data['referraltype_id'] , array('id' => 'form_referraltype_id')) !!} @endif @if(array_key_exists('action', $data)) {!! Form::hidden('action', $data['action'], array('id' => 'form_action')) !!} @endif @if(array_key_exists('patient_id', $data)) {!! Form::hidden('patient_id', $data['patient_id'], array('id' => 'form_patient_id')) !!} @endif {!! Form::hidden('provider_id', '', array('id' => 'form_provider_id')) !!} {!! Form::hidden('practice_id', '', array('id' => 'form_practice_id')) !!} {!! Form::hidden('appointment_date', '', array('id' => 'form_appointment_date')) !!} {!! Form::hidden('appointment_time', '', array('id' => 'form_appointment_time')) !!} {!! Form::hidden('appointment_type_name', '', array('id' => 'form_appointment_type_name')) !!} {!! Form::hidden('appointment_type_id', '', array('id' => 'form_appointment_type_id')) !!} {!! Form::hidden('location', '', array('id' => 'form_location')) !!} {!! Form::close() !!}
