    ...
    <div class="modal-dialog form_model">
        ...
        <div class="modal-content ">
            <div class="modal-header">
                ...
                <h4 class="action_modal_title" id="action_header" style="color:black;text-align:center">Impersonate User</h4>
            </div>
            ...
            <div class="modal-footer">
                <div style="margin-right:40%">
                    <button type="button" onclick="beginImpersonation()" class="btn btn-primary confirm_action active" >Impersonate</button>
