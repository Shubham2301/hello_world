<div class="patient_records_info arial">
    ...
    <div class="patient_demo_info">
        <p>
            <span class="patient_name arial_bold">Allen Rovenstien</span>
        </p>
        <p>
            <span class="patient_phone">470-237-4501</span>
        </p>
    </div>
    <div class="patient_appt_info ">
        <p class="info_header arial_bold">Appointment Information</p>
        <p>
            <span class="scheduled_to arial">Dr. Barnes, Eric</span>
            <br>
            <span class="appointment_date arial">23 January, 2015, 2:00:AM</span>
            <br>
            <span class="appointment_type arial">Annual Eye Exam</span>
        </p>
    </div>
