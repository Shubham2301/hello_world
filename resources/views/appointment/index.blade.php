        ...
        <div class="row appointment_info center-align">
            <div class="col-sm-4 col-xs-12 appointment_info_div">
                <div class="appointment_info_box patient">
                    ...
                    <div style="width:40%;align-self: center;"><img src="{{URL::asset('images/patient-img.png')}}" style="width:100%;"></div>
            ...
            <div class="col-sm-4 col-xs-12 appointment_info_div">
                <div class="appointment_info_box provider">
                    ...
                    <div style="width:40%;align-self: center;"><img src="{{URL::asset('images/provider-img.png')}}" style="width:100%;"></div>
