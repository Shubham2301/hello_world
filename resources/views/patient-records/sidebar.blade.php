<div class="no-padding">
	...
	<ul class="sidebar_item_list">
		<li class="admin_sidebar_menu_item">
			<a class=" subsection_admin_add" href="/administration/practices/create">
			</a>
			<a class="sidebar_button_subsection subsection_admin_title practices" href="#" id="button_active" >
				<span style="color:#4d4d4d">Patient Records</span>
			</a>
		</li>
		<li class="admin_sidebar_menu_item">
			<a class="subsection_admin_add" href="/administration/users/create">
			</a>
