    ...
    <div class="panel panel-default">
        ...
        <div id="collapse1" class="panel-collapse collapse in">
            <div class="panel-body">
                <div class="row content-row-margin">
                    <div class="col-sm-6 col-xs-12">
                        ...
                        {!! Form::text('cellphone', $data['cellphone'], array('class' => 'add_patient_input phone_visible', 'name' => 'cellphone', 'placeholder' => 'Cellphone', 'id' => 'phone', 'data-toggle' => 'tooltip', 'title' => 'Cellphone', 'data-placement' => 'right')) !!}
            @if($data['workphone'] == '' || $data['homephone'] == '')<span class="add_another_phone" data-toggle="tooltip" title="Add another phone number" data-placement="right"><img src="{{URL::asset('images/plus_icon.png')}}"></span> @endif
                        ...
                        @endif
                        {!! Form::text('workphone', $data['workphone'], array('class' => 'add_patient_input', 'name' => 'workphone', 'placeholder' => 'Workphone', 'id' => 'workphone', 'data-toggle' => 'tooltip', 'title' => 'Workphone', 'data-placement' => 'right')) !!}</span> @if($data['homephone'] == '')
                        <span class="homephone_span hide_phone_field">
                        @else
                            <span class="homephone_span">
                        @endif
                        {!! Form::text('homephone', $data['homephone'], array('class' => 'add_patient_input', 'name' => 'homephone', 'placeholder' => 'Homephone', 'id' => 'homephone', 'data-toggle' => 'tooltip', 'title' => 'Homephone', 'data-placement' => 'right')) !!}</span>
                    </div>
                    <div class="col-sm-6 col-xs-12">
                        <!--
...
-->
                        ...
                        {!! Form::text('DateOfBirth', $data['birthdate'], array('class' => 'add_patient_input', 'name' => 'birthdate', 'placeholder' => 'Date of Birth', 'id' => 'dob', 'required' => 'required', 'data-toggle' => 'tooltip', 'title' => 'Date of Birth', 'data-placement' => 'right')) !!}
                        {!! Form::text('last_4_ssn', $data['lastfourssn'], array('class' => 'add_patient_input', 'name' => 'lastfourssn', 'placeholder' => 'Last 4 SSN', 'id' => 'last_4_ssn', 'data-toggle' => 'tooltip', 'title' => 'Last 4 SSN', 'data-placement' => 'right')) !!}
                        <!--
    ...
    <div class="panel panel-default">
        ...
        <div id="collapse2" class="panel-collapse collapse">
            <div class="panel-body">
                <div class="row content-row-margin">
                    <div class="col-sm-6 col-xs-12">
                        {!! Form::text('address_1', $data['addressline1'], array('class' => 'add_patient_input', 'name' => 'addressline1', 'placeholder' => 'Address 1', 'id' => 'Address_1', 'data-toggle' => 'tooltip', 'title' => 'Address Line 1', 'data-placement' => 'right')) !!}
                        {!! Form::text('address_2', $data['addressline2'], array('class' => 'add_patient_input', 'name' => 'addressline2', 'placeholder' => 'Address 2', 'id' => 'Address_2', 'data-toggle' => 'tooltip', 'title' => 'Address Line 2', 'data-placement' => 'right')) !!}
                        ...
                        @if(!$data['admin'])
                            {!! Form::hidden('referraltype_id', $data['referraltype_id'], array('name' => 'referraltype_id' , 'id' => 'form_referraltype_id')) !!} {!! Form::hidden('action', $data['action'], array('name' => 'action' , 'id' => 'form_action')) !!} @endif
                    </div>
                </div>
            </div>
        </div>
