                    ...
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <span class="workphone_span hide_phone_field">
                            ...
                            <div class="col-sm-6 col-xs-12">
                                ...
                                {!! Form::select('engagement_preference', Helper::messageTypes(), Helper::ifExists('engagement_preference', $data), array('class' => 'add_patient_input', 'placeholder' => 'Engagement Preference*', 'id' => 'engagement_preference', 'required' => 'required', 'data-toggle' => 'tooltip', 'title' => 'Engagement Preference', 'data-placement' => 'right')) !!}
                            </div>
                        </div>
                    </div>
                </div>
