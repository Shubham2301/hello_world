            ...
            <div class="panel panel-default">
                ...
                <div id="collapse5" class="panel-collapse collapse">
                    <div class="panel-body">
                        <div class="row content-row-margin">
                            <div class="col-sm-6 col-xs-12">
                                {!! Form::text('address_1', Helper::ifExists('insurance_carrier', $data), array('class' => 'add_patient_input', 'name' => 'insurance_carrier', 'placeholder' => 'Insurance Carrier', 'id' => 'insurance_carrier', 'data-toggle' => 'tooltip', 'title' => 'Insurance Carrier', 'data-placement' => 'right')) !!}
                                {!! Form::text('address_1', Helper::ifExists('subscriber_birthdate', $data) , array('class' => 'add_patient_input', 'name' => 'subscriber_birthdate', 'placeholder' => 'Subscriber DOB', 'id' => 'subscriber_birthdate', 'data-toggle' => 'tooltip', 'title' => 'Subscriber DOB', 'data-placement' => 'right')) !!}
                                {!! Form::text('address_1', Helper::ifExists('insurance_group_no', $data) , array('class' => 'add_patient_input', 'name' => 'insurance_group_no', 'placeholder' => 'Group #', 'id' => 'insurance_group_no', 'data-toggle' => 'tooltip', 'title' => 'Group #', 'data-placement' => 'right')) !!}
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                {!! Form::text('address_1', Helper::ifExists('subscriber_name', $data) , array('class' => 'add_patient_input', 'name' => 'subscriber_name', 'placeholder' => 'Subscriber Name', 'id' => 'subscriber_name', 'data-toggle' => 'tooltip', 'title' => 'Subscriber Name', 'data-placement' => 'right')) !!}
                                {!! Form::text('address_1', Helper::ifExists('subscriber_id', $data) , array('class' => 'add_patient_input', 'name' => 'subscriber_id', 'placeholder' => 'Subscriber ID', 'id' => 'subscriber_id', 'data-toggle' => 'tooltip', 'title' => 'Subscriber ID', 'data-placement' => 'right')) !!}
                                {!! Form::text('address_1', Helper::ifExists('subscriber_relation', $data) , array('class' => 'add_patient_input', 'name' => 'subscriber_relation', 'placeholder' => 'Relation to Patient', 'id' => 'subscriber_relation', 'data-toggle' => 'tooltip', 'title' => 'Relation to Patient', 'data-placement' => 'right')) !!}
                            </div>
                        </div>
                    </div>
                </div>
