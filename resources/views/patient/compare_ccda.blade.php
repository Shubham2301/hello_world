        ...
        <div class="modal-content  ">
            <div class="modal-header" style="border-bottom:none;">
                ...
                <p class="update_header active"><strong>Please select the patient information you
                    <br> want to import CCDA file into ocuhub</strong></p>
            </div>
            <div class="modal-body">
                <div class="content-section active">
                    <div class="compare_form active">
                        {!! Form::open(array('url' => 'update/ccda', 'method' => 'POST', 'files'=>true,'id'=>'compare_ccda_form')) !!}
                        {!! Form::hidden('patient_id', '', array('id' => 'compared_patient_id')) !!}
                        ...
                        <div class="row ">
                            <div class="col-md-12 campare_items">
            ...
            <div class="modal-footer">
                <div style="margin-right:40%">
                    <button type="button" class="btn compare_ccda_button active">Change</button>
