...
<ul class="sidebar_item_list">
	...
	<li class="sidebar_menu_item"><a class="sidebar_item" href="/home"><span class="menu_item_icon"><img src="{{URL::asset('images/sidebar/schedule.png')}}" class="image"></span><span class="menu_item_label">Schedule Appointment</span></a></li>
