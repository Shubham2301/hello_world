...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <a href="/home">
                <button class="btn back_btn">Cancel</button>
            </a>
        </div>
        <form method="POST" action="/updateprofile">
            ...
            <div class="col-xs-12">
                <div class="col-xs-5 center-align">
                    <img src="{{URL::asset('images/users/user_'. Auth::user()->id .'.jpg')}}" class="img-responsive edit_profile_img" onerror="this.src = '{{URL::asset('images/sidebar/care_coordinator.png')}}'">
                    <br>
