...
<div class="dropdown" >
    ...
    <div class="row admin">
        <a class="sidebar-item" href="#">
            <div class="col-lg-6 col-md-6 patients font_change">Practices</div><div class="col-lg-6 col-md-6 sidebar-item-left"><span><img src="{{URL::asset('images/sidebar/patient.png')}}" class="patient"></span>&nbsp;add<span><img src="{{URL::asset('images/sidebar/patient_add.png')}}" class="image"></span></div></a>
    </div>
    <div class="row admin">
        <a class="sidebar-item" href="/users">
            <div class="col-lg-6 col-md-6 users font_change">Users</div><div class="col-lg-6 col-md-6 sidebar-item-left"><span><img src="{{URL::asset('images/sidebar/users.png')}}" class="patient"></span>&nbsp;add<span><img src="{{URL::asset('images/sidebar/users_add.png')}}" class="image"></span></div></a>
    </div>
    <div class="row admin">
        <a class="sidebar-item" href="/practices">
            <div class="col-lg-6 col-md-6 practice font_change">Roles</div><div class="col-lg-6 col-md-6 sidebar-item-left"><span><img src="{{URL::asset('images/sidebar/practice.png')}}" class="patient"></span>&nbsp;add<span><img src="{{URL::asset('images/sidebar/practice_add.png')}}" class="image"></span></div></a>
    </div>
    <div class="row admin">
        <a class="sidebar-item" href="#">
