...
function printList() {
    ...
    info[0].forEach(function (referraltype) {
        content += '<div class="referral_type"><span class="glyphicon glyphicon-remove-circle remove_referral_type" data-id="' + referraltype.id + '"></span><div class="tile" id="openModel" data-toggle="modal" data-target="#' + referraltype.id + '" style="color:' + referraltype.color_indicator + '"><center><span class="tile_bar" style="background-color:' + referraltype.description + '"></span><br><p class="tile_name">' + referraltype.name + '</p></center></div>' + referraltype.display_name + '</div><div id="' + referraltype.id + '" class="modal fade" role="dialog" data-id="' + referraltype.id + '"><div class="modal-dialog alert"><div class="modal-content"><div class="modal-body alert"><span style="color:#4d4d4d;padding:1em;">' + referraltype.clinical_protocol + '</span><div class="modal-footer" style="text-align:center;"><button type="button" class="btn btn-primary referr_patient" data-id="' + referraltype.id + '">Confirm</button><button type="button" class="btn dismiss_button" data-dismiss="modal" style="color:#4d4d4d;">Cancel</button></div></div></div></div></div>';
