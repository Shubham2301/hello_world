...
$(document).ready(function() {
    ...
    $('.practice_list').on('click', '.location_address_previous', function() {
        ...
        if (counter > 0) {
            var address = locationAddress[index][counter - 1].addressline1 + '<br>' + locationAddress[index][counter - 1].addressline2;
